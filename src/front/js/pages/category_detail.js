                ...
                return (
                  <div key={i}>
                    <Beerdetail
                      ...
                      databeer={elem}
                      elemindex={i}
                      image={elem.image == "" ? "https://craftsnippets.com/articles_images/placeholder/placeholder.jpg" : elem.image }
                      nombre={elem.name}
                    />
                    <Link
                      to="#"
                    ...
                    >
                      <CardCategoryMini image={elem.image == "" ? "https://craftsnippets.com/articles_images/placeholder/placeholder.jpg" : elem.image } nombre={elem.name} />
                    </Link>
                  </div>
                );
              })
